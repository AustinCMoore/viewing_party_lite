...
RSpec.describe User, type: :model do
  ...
  describe '#host' do
    it 'returns parties where the user is the host' do
      ...
      User.destroy_all
      Party.destroy_all
      user = User.create!(name: 'Host', email: 'host@mail.com', password: 'password')
      user_1 = User.create!(name: 'not host', email: 'nohost@mail.com', password: 'password')
      user_2 = User.create!(name: 'also not host', email: 'neitherhost@mail.com', password: 'password')
  ...
  describe '#invitations' do
    it 'returns parties that a user has been invited to' do
      ...
      Party.destroy_all
      user = User.create!(name: 'Host', email: 'host@mail.com', password: 'password')
      user_2 = User.create!(name: 'not host', email: 'nohost@mail.com', password: 'password')
      user_3 = User.create!(name: 'also not host', email: 'neitherhost@mail.com', password: 'password')
      user_4 = User.create!(name: 'still not host', email: 'neithermost@mail.com', password: 'password')
      party_1 = Party.create!(start_date: '2022-03-25', duration: 90, start_time: '5:00', movie_id: 1253,
        host_id: user.id)
      party_2 = Party.create!(start_date: '2022-03-25', duration: 100, start_time: '6:00', movie_id: 352,
        host_id: user_2.id)
